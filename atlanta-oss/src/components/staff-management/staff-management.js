...
import {Edit, Delete, AddCircleOutline, RemoveCircleOutline, Visibility} from '@mui/icons-material';
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      const response = await axios.put(
        `${config.apiBaseUrl}/staffs/update_staff/${selectedStaff.staffid}`,
        selectedStaff,
        {
          headers: {Authorization: `Bearer ${token}`},
        }
    ...
    <div>
      ...
      <Container>
        ...
        <Dialog open={openDeleteDialog} onClose={handleCloseDeleteDialog}>
          ...
          <DialogContent>
            <DialogContentText>คุณต้องการลบข้อมูลพนังงานคนนี้ใช่หรือไม่?</DialogContentText>
          </DialogContent>
          <DialogActions>
        ...
        <Dialog open={openEditDialog} onClose={handleCloseEditDialog} maxWidth='sm' fullWidth>
          ...
          <DialogContent>
            <DialogContentText>แก้ไขข้อมูลพนักงาน และ แก้ไขวันลาต่างๆของพนักงาน</DialogContentText>
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  onChange={(e) =>
                    setSelectedStaff({
                      ...selectedStaff,
                      staff_econtract: e.target.value,
                    })
                  }
                />
              </Grid>

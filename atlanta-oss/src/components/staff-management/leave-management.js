...
export default function LeaveManagement() {
    ...
    const handleUpdateRequest = async (requestId, status) => {
        ...
        setLoading(true);
        try{
            await axios.put(`${config.apiBaseUrl}/leave_requests/update_leave_requests`, {
                            ...
                            <TableBody>
                                {paginatedRequests.map((request) => (
                                    <TableRow key={request.request_id}>
                                        <TableCell>{request.user_account.user_name}</TableCell>
                                        ...
                                        <TableCell>
                                            ...
                                            <Button 
                                                variant="contained" 
                                                color="warning"
                                                onClick={() => handleOpenDialog(request.reason)}
                                            >
                                                ดูข้อมูลเพิ่มเติม
                                            </Button>
                                        </TableCell>

...
export default function TaskManagement() {
    ...
    const getStaffNickname = (staffCardId) => {
        const staff = staffDetails.find((s) => s.staff_cardid === staffCardId);
        return staff ? staff.staff_nickname : 'Unknown';
    };

    return (
        <div>
            <CustomNavbar />
            <Typography variant="h4" sx={{ mt: 4, mb: 4, ml: 23 }} gutterBottom>
            ...
            {loading ? (
                ...
                <TableContainer component={Paper} sx={{ mt: 4, mx: 'auto', maxWidth: '70%' }}>
                    <Table>
                        <TableHead>
                            <TableRow>
                        ...
                        <TableBody>
                            {tasks.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((task) => (
                                <TableRow key={task.taskid}>
                                    ...
                                    <TableCell>{getStaffNickname(task.staff_cardid)}</TableCell>
                                    <TableCell>
                                        <Button
                                            variant="contained"
                                            color="primary"

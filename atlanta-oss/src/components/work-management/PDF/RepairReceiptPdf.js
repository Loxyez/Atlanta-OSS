    ...
    return (
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.header}>
                    <Text style={styles.logo_left}>รุ่น: {data.task_device_category}:{data.task_device_model}</Text>
                    <Text style={styles.receipt_type_left}></Text>
                    <Text style={styles.empty}></Text>
                    <Text style={styles.date_left}></Text>
                    ...
                    <Text style={styles.logo_right}>รุ่น: {data.task_device_category}:{data.task_device_model}</Text>
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.detials}>อาการที่พบเจอ:              3...........................................................</Text>
                </View>
                ...
                {/* Details */}
                <View style={styles.header}>
                    <Text style={styles.detials}>- {data.task_device_category}:{data.task_device_model}</Text>
                ...
                <View style={styles.header}>
                    <Text style={styles.noti}>
                        ...
                        - กรุณาสำรองงานก่อนนำเรื่องเข้ารับการซ่อม หากเกิดการสูญหายทางร้านจะไม่รับผิดชอบทุกกรณี
                    </Text>

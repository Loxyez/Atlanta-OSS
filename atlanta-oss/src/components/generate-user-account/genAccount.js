            ...
            <form>
              <Grid container spacing={2}>
                <Grid item xs={12} sm={6}>
                  ...
                  <Select fullWidth value={ticketID} onChange={handleTicketChange} displayEmpty>
                ...
                <Box mt={2}>
                  <Grid container spacing={2}>
                    <Grid item xs={12} sm={6}>
                      ...
                      <TextField fullWidth value={selectedRequest.email} readOnly />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <InputLabel style={{color: 'black'}}>Telephone</InputLabel>
                      <TextField fullWidth value={selectedRequest.tel} readOnly />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <InputLabel style={{color: 'black'}}>Role</InputLabel>
                      <TextField fullWidth value={selectedRequest.role} readOnly />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                  ...
                  <Box mt={2} textAlign='right'>
                    <Button variant='contained' color='primary' onClick={handleStatusChange} disabled={loading}>
              ...
              <Table>
                ...
                <TableBody>
                  {loadingAccount ? (
                    ...
                    requestAccounts.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => (
                      <TableRow key={row.staff_cardid}>
                        ...
                        <TableCell>
                          <Button
                            variant='contained'
                            onClick={() => sendEmail(row.user_name, row.user_name, row.user_ac_password)}
                          >
                            Send Email
                          </Button>
                        </TableCell>
